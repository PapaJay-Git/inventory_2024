...
<div class="container shadow-background bg-inner-card-primary border-r-15px transition-all">
    <div class="row py-5" >
        <div class="col-12 col-md-5 col-lg-6 col-xl-7 d-lg-flex flex-column justify-content-center align-items-center d-none py-5">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12">
                                <div class="password-container">
                                    <input id="password" type="password" class="form-control p-3 @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" placeholder="Password">
