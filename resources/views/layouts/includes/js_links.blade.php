...
@auth
    ...
    <script src="{{ asset('js/assets/dataTables/jquery.dataTables.min.js') }}?v={{ config('app.scripts_version') }}">
    </script>
    <script src="{{ asset('js/assets/dataTables/dataTables.buttons.min.js') }}?v={{ config('app.scripts_version') }}">
    </script>
