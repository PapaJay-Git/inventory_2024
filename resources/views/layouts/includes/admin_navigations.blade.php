<nav class="bg-primary shadow-sm fixed-top">
    <div class="container d-flex flex-column flex-md-row justify-content-md-between py-1 py-md-3">
        ...
        <div class="px-2 px-md-0 pt-4 pt-md-0">
            <ul class="d-flex flex-row list-unstyled justify-content-between justify-content-md-end gap-2 gap-sm-3 h-100 align-items-center ms-auto w-100" >
                <li class="nav-item dropdown ">
                    <a class="nav-link fw-bold text-white d-flex justify-content-center align-items-center flex-column" href="{{ url('/') }}">
                ...
                <li class="nav-item dropdown ">
                    <a class="nav-link fw-bold text-white d-flex justify-content-center align-items-center flex-column" href="{{ url('/barangay-accounts') }}">
                ...
                <li class="nav-item dropdown ">
                    ...
                    <div class="dropdown-menu dropdown-menu-end bg-primary px-2" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item fw-bold text-white bg-primary" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                            LOGOUT
                        </a>
