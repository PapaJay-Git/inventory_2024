        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <span class="mx-1 fw-bold">UPDATE KABABAIHANS RECORD</span>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('kababaihans.update', $kababaihan->id) }}" method="POST"
                        ...
                        <div class="row row-gap-3">
                                    ...
                                    <div class="card d-flex flex-row overflow-hidden" style="min-width: 5rem; height: 5rem"
                                        id="photo-container">
                                            @foreach (json_decode($kababaihan->image_paths, true) as $path)
                                                <img src="{{ config('app.kababaihan_images_path') . $path }}" style="width: 100%; height: 100%; object-fit: cover;" alt="PWD Photo Preview">
                                            @endforeach
                                    </div>
                                    <div>
                            ...
                            <div class="col-6 col-md-6 col-lg-3">
                                ...
                                <input id="date" type="date"
                                    ...
                                    value="{{ old('date') ?? $kababaihan->date }}" required>
                            ...
                            @foreach (config('app.kababaihan_names') as $kababaihan_name)
                                <div class="col-6 col-md-6 col-lg-3">
                                    ...
                                    <input id="{{ $kababaihan_name }}" type="text"
                                        ...
                                        name="{{ $kababaihan_name }}" value="{{ old($kababaihan_name) ?? $kababaihan[$kababaihan_name] }}">
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                ...
                                <input id="city_address" type="text"
                                    ...
                                    name="city_address" value="{{ old('city_address') ?? $kababaihan->city_address }}" required>
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                ...
                                <input id="provincial_address" type="text"
                                    ...
                                    name="provincial_address" value="{{ old('provincial_address') ?? $kababaihan->provincial_address  }}" required>
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                ...
                                <input id="birth_place" type="text"
                                    ...
                                    name="birth_place" value="{{ old('birth_place') ?? $kababaihan->birth_place }}" required>
                            ...
                            <div class="col-6 col-md-3 col-lg-3">
                                ...
                                <input id="date_of_birth" type="date"
                                    ...
                                    name="date_of_birth" value="{{ old('date_of_birth') ?? $kababaihan->date_of_birth }}" required>
                                    ...
                                    <select id="civil_status"
                                        ...
                                        @foreach (config('app.civil_status') as $civil_statusField)
                                            <option value="{{ $civil_statusField }}"
                                                {{ (old('civil_status') ?? $kababaihan->civil_status )== $civil_statusField ? 'selected' : '' }}>
                            ...
                            <div class="col-md-4 col-lg-3">
                                ...
                                <div>
                                    <input id="citizenship" type="text"
                                        ...
                                        name="citizenship" value="{{ old('citizenship') ?? $kababaihan->citizenship }}" required>
                                    @error('citizenship')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-4 col-lg-3">
                                ...
                                <div>
                                    <input id="religion" type="text"
                                        ...
                                        value="{{ old('religion')  ?? $kababaihan->religion }}" required>
                                    @error('religion')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-4 col-lg-3">
                                ...
                                <div>
                                    <input id="mobile_number" type="text"
                                        ...
                                        name="mobile_number" value="{{ old('mobile_number')  ?? $kababaihan->mobile_number }}" required>
                                    @error('mobile_number')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <select id="occupation"
                                    ...
                                    @foreach (config('app.occupation') as $occupationField)
                                        <option value="{{ $occupationField }}"
                                            {{ (old('occupation') ?? $kababaihan->occupation) == $occupationField ? 'selected' : '' }}>
                            ...
                            <div class="col-md-4 col-lg-3">
                                ...
                                <div>
                                    <input id="name_of_company" type="text"
                                        ...
                                        name="name_of_company" value="{{ old('name_of_company') ?? $kababaihan->name_of_company }}" >
                            ...
                            <div class="col-md-4 col-lg-3">
                                ...
                                <div>
                                    <input id="company_address" type="text"
                                        ...
                                        name="company_address" value="{{ old('company_address') ?? $kababaihan->company_address }}" >
                                ...
                                <select id="educational_attainment"
                                    ...
                                    @foreach (config('app.educational_attainment') as $educational_attainmentField)
                                        <option value="{{ $educational_attainmentField }}"
                                            {{ (old('educational_attainment') ?? $kababaihan->educational_attainment) == $educational_attainmentField ? 'selected' : '' }}>
                            ...
                            <div class="col-md-4 col-lg-3">
                                ...
                                <div>
                                    <input id="spouse_name" type="text"
                                        ...
                                        name="spouse_name" value="{{ old('spouse_name') ?? $kababaihan->spouse_name }}" >
                                    @error('spouse_name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <select id="spouse_occupation"
                                    ...
                                    @foreach (config('app.occupation') as $spouse_occupationField)
                                        <option value="{{ $spouse_occupationField }}"
                                            {{ (old('spouse_occupation') ?? $kababaihan->spouse_occupation) == $spouse_occupationField ? 'selected' : '' }}>
                            ...
                            <div class="col-md-4 col-lg-3">
                                ...
                                <div>
                                    <input id="number_of_children" type="number"
                                        ...
                                        name="number_of_children" value="{{ old('number_of_children') ?? $kababaihan->number_of_children }}" required>
                            ...
                            <div class="col-md-4 col-lg-3">
                                ...
                                <div>
                                    <input id="other_organizations_membership" type="text"
                                        ...
                                        value="{{ old('other_organizations_membership') ?? $kababaihan->other_organizations_membership }}" >
                            ...
                            <div class="col-md-6 col-lg-6">
                                ...
                                <div>
                                    <input id="emergency_contact_name" type="text"
                                        ...
                                        name="emergency_contact_name" value="{{ old('emergency_contact_name')  ?? $kababaihan->emergency_contact_name }}"
                                        required>
                            ...
                            <div class="col-md-6 col-lg-6">
                                ...
                                <div>
                                    <input id="emergency_contact_number" type="text"
                                        ...
                                        name="emergency_contact_number" value="{{ old('emergency_contact_number') ?? $kababaihan->emergency_contact_number }}"
                                        required>
