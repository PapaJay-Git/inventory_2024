...
@section('content')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <span class="mx-1 fw-bold">UPDATE SOLO - PARENT RECORD</span>
                    ...
                    <div class="card-body">
                        ...
                        <form action="/solo_parents/{{ $soloParent->id }}" method="POST"
                            ...
                            <div class="row row-gap-3">
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    ...
                                    <input id="case_number" type="text"
                                        ...
                                        value="{{ old('case_number') ?? $soloParent->case_number }}" required
                                ...
                                <div class="col-12 col-md-4 col-lg-3">
                                    ...
                                    <div>
                                        <input id="philsys_card_number" type="text"
                                            ...
                                            value="{{ old('philsys_card_number') ?? $soloParent->philsys_card_number }}"
                                            required>
                                ...
                                <div class="col-12 col-md-4 col-lg-3">
                                    ...
                                    <input id="date_of_birth" type="date"
                                        ...
                                        name="date_of_birth"
                                        value="{{ old('date_of_birth') ?? $soloParent->date_of_birth }}" required>
                                    @error('date_of_birth')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="col-12 col-md-4 col-lg-6">
                                        ...
                                        <select id="sex" class="form-control  @error('sex') is-invalid @enderror"
                                            ...
                                            @foreach (config('app.sex') as $sex)
                                                <option value="{{ $sex }}"
                                                    {{ (old('sex') ?? $soloParent->sex) == $sex ? 'selected' : '' }}>
                                                    {{ $sex }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-12 col-md-4 col-lg-6">
                                        ...
                                        <div>
                                            <input id="age" type="number"
                                                ...
                                                value="{{ old('age') ?? $soloParent->age }}" required>
                                            @error('age')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-12 col-md-4 col-lg-6">
                                        ...
                                        <div>
                                            <input id="place_of_birth" type="text"
                                                ...
                                                name="place_of_birth"
                                                value="{{ old('place_of_birth') ?? $soloParent->place_of_birth }}"
                                                required>
                                    ...
                                    <select id="educational_attainment"
                                        ...
                                        @foreach (config('app.educational_attainment') as $educational_attainmentField)
                                            <option value="{{ $educational_attainmentField }}"
                                                {{ (old('educational_attainment') ?? $soloParent->educational_attainment) == $educational_attainmentField ? 'selected' : '' }}>
                                        ...
                                        <select id="civil_status"
                                            ...
                                            @foreach (config('app.civil_status') as $civil_statusField)
                                                <option value="{{ $civil_statusField }}"
                                                    {{ (old('civil_status') ?? $soloParent->civil_status) == $civil_statusField ? 'selected' : '' }}>
                                    ...
                                    <select id="occupation"
                                        ...
                                        @foreach (config('app.occupation') as $occupationField)
                                            <option value="{{ $occupationField }}"
                                                {{ (old('occupation') ?? $soloParent->occupation) == $occupationField ? 'selected' : '' }}>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div>
                                            <input id="religion" type="text"
                                                ...
                                                name="religion" value="{{ old('religion') ?? $soloParent->religion }}">
                                            @error('religion')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div>
                                            <input id="company_agency" type="text"
                                                ...
                                                name="company_agency"
                                                value="{{ old('company_agency') ?? $soloParent->company_agency }}"
                                                required>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div>
                                            <input id="monthly_income" type="number"
                                                ...
                                                name="monthly_income"
                                                value="{{ old('monthly_income') ?? $soloParent->monthly_income }}"
                                                required>
                                    ...
                                    <select id="status_of_employment"
                                        ...
                                        @foreach (config('app.status_of_employment') as $status_of_employmentField)
                                            <option value="{{ $status_of_employmentField }}"
                                                {{ (old('status_of_employment') ?? $soloParent->status_of_employment) == $status_of_employmentField ? 'selected' : '' }}>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div>
                                            <input id="contact_numbers" type="text"
                                                ...
                                                value="{{ old('contact_numbers') ?? $soloParent->contact_numbers }}"
                                                required>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div>
                                            <input id="email_address" type="email"
                                                ...
                                                name="email_address"
                                                value="{{ old('email_address') ?? $soloParent->email_address }}" required>
                                            @error('email_address')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div>
                                                <select
                                                    ...
                                                    <option value="0"
                                                        {{ old('pantawid_beneficiary') ?? $soloParent->pantawid_beneficiary ? 'selected' : '' }}>
                                                        No</option>
                                                    <option value="1"
                                                        {{ old('pantawid_beneficiary') ?? $soloParent->pantawid_beneficiary ? 'selected' : '' }}>
                                                        Yes</option>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div>
                                                <input id="household_id" type="text"
                                                    ...
                                                    name="household_id"
                                                    value="{{ old('household_id') ?? $soloParent->household_id }}">
                                                @error('household_id')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div>
                                                <select
                                                    ...
                                                    <option value="0"
                                                        {{ old('indigenous_person') ?? $soloParent->indigenous_person ? 'selected' : '' }}>
                                                        No</option>
                                                    <option value="1"
                                                        {{ old('indigenous_person') ?? $soloParent->indigenous_person ? 'selected' : '' }}>
                                                        Yes</option>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div>
                                                <input id="affiliation" type="text"
                                                    ...
                                                    name="affiliation"
                                                    value="{{ old('affiliation') ?? $soloParent->affiliation }}">
                                                @error('affiliation')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div>
                                                <select class="form-control  @error('lgbtq') is-invalid @enderror"
                                                    name="lgbtq" id="lgbtq">
                                                    <option value="0"
                                                        {{ old('lgbtq') ?? $soloParent->lgbtq ? 'selected' : '' }}>No
                                                    </option>
                                                    <option value="1"
                                                        {{ old('lgbtq') ?? $soloParent->lgbtq ? 'selected' : '' }}>Yes
                                                    </option>
                                                </select>
                                                @error('lgbtq')
                                                    <span class="invalid-feedback d-block" role="alert">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div>
                                                <select class="form-control  @error('pwd') is-invalid @enderror"
                                                    name="pwd" id="pwd">
                                                    <option value="0"
                                                        {{ old('pwd') ?? $soloParent->pwd ? 'selected' : '' }}>No</option>
                                                    <option value="1"
                                                        {{ old('pwd') ?? $soloParent->pwd ? 'selected' : '' }}>Yes</option>
                                                </select>
                                                @error('pwd')
                                                    <span class="invalid-feedback d-block" role="alert">
                                                        <strong>{{ $message }}</strong>
                                ...
                                <div class="col-12">
                                    <div id="household_compositions">
                                        ...
                                        @foreach (old('householdCompositions') ?? ($soloParent->householdCompositions ?? []) as $index => $hC)
                                            <div class="row mb-2 row-gap-2 pb-2"
                                                ...
                                                <div class="col-md-4 col-lg-4">
                                                    ...
                                                    <div>
                                                        <input id="full_name_{{ $index }}" type="text"
                                                            ...
                                                            value="{{ old('householdCompositions.' . $index . '.full_name') ?? ($hC['full_name'] ?? '') }}">
                                                ...
                                                <div class="col-md-4 col-lg-2">
                                                    ...
                                                    <select id="sex_{{ $index }}"
                                                        ...
                                                        @foreach (config('app.sex') as $sex)
                                                            <option value="{{ $sex }}"
                                                                {{ (old('householdCompositions.' . $index . '.sex') ?? ($hC['sex'] ?? '')) == $sex ? 'selected' : '' }}>
                                                                {{ $sex }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-md-4 col-lg-2">
                                                    ...
                                                    <div>
                                                        <input id="relationship_{{ $index }}" type="text"
                                                            ...
                                                            value="{{ old('householdCompositions.' . $index . '.relationship') ?? ($hC['relationship'] ?? '') }}">
                                                ...
                                                <div class="col-md-4 col-lg-2">
                                                    ...
                                                    <div>
                                                        <input id="age_{{ $index }}" type="number"
                                                            ...
                                                            value="{{ old('householdCompositions.' . $index . '.age') ?? ($hC['age'] ?? '') }}">
                                                ...
                                                <div class="col-md-4 col-lg-2">
                                                    ...
                                                    <div>
                                                        <input id="birthdate_{{ $index }}" type="date"
                                                            ...
                                                            value="{{ old('householdCompositions.' . $index . '.birthdate') ?? ($hC['birthdate'] ?? '') }}">
                                                ...
                                                <div class="col-md-4 col-lg-3">
                                                    ...
                                                    <div>
                                                        <select id="civil_status_{{ $index }}"
                                                            ...
                                                            @foreach (config('app.civil_status') as $civil_statusField)
                                                                <option value="{{ $civil_statusField }}"
                                                                    {{ (old('householdCompositions.' . $index . '.civil_status') ?? ($hC['civil_status'] ?? '')) == $civil_statusField ? 'selected' : '' }}>
                                                                    {{ $civil_statusField }}</option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="col-md-4 col-lg-3">
                                                    <label
                                                        ...
                                                        <select id="educational_attainment_{{ $index }}"
                                                            ...
                                                            @foreach (config('app.educational_attainment') as $educational_attainmentField)
                                                                <option value="{{ $educational_attainmentField }}"
                                                                    {{ (old('householdCompositions.' . $index . '.educational_attainment') ?? ($hC['educational_attainment'] ?? '')) == $educational_attainmentField ? 'selected' : '' }}>
                                                                    {{ $educational_attainmentField }}</option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="col-md-4 col-lg-3">
                                                    ...
                                                    <select id="occupation_{{ $index }}"
                                                        ...
                                                        @foreach (config('app.occupation') as $occupationField)
                                                            <option value="{{ $occupationField }}"
                                                                {{ (old('householdCompositions.' . $index . '.occupation') ?? ($hC['occupation'] ?? '')) == $occupationField ? 'selected' : '' }}>
                                                                {{ $occupationField }}</option>
                                                        @endforeach
                                                    </select>
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div>
                                                            <input id="monthly_income_{{ $index }}"
                                                                ...
                                                                value="{{ old('householdCompositions.' . $index . '.monthly_income') ?? ($hC['monthly_income'] ?? '') }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea class="form-control @error('classification_circumstances') is-invalid @enderror"
                                        id="classification_circumstances" name="classification_circumstances" required>{{ old('classification_circumstances') ?? $soloParent->classification_circumstances }}</textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea class="form-control @error('needs_problems') is-invalid @enderror" id="needs_problems"
                                        name="needs_problems" required>{{ old('needs_problems') ?? $soloParent->needs_problems }}</textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6 col-lg-3">
                                            ...
                                            <input id="emergency_name" type="text" name="emergency_name"
                                                value="{{ old('emergency_name') ?? $soloParent->emergency_name }}"
                                        ...
                                        <div class="col-12 col-md-6 col-lg-3">
                                            ...
                                            <input id="emergency_relationship" type="text"
                                                ...
                                                value="{{ old('emergency_relationship') ?? $soloParent->emergency_relationship }}"
                                        ...
                                        <div class="col-12 col-md-6 col-lg-3">
                                            ...
                                            <input id="emergency_address" type="text" name="emergency_address"
                                                value="{{ old('emergency_address') ?? $soloParent->emergency_address }}"
                                        ...
                                        <div class="col-12 col-md-6 col-lg-3">
                                            ...
                                            <input id="emergency_number" type="text" name="emergency_number"
                                                value="{{ old('emergency_number') ?? $soloParent->emergency_number }}"
                                    ...
                                    <select id="spo_status"
                                        ...
                                        @foreach (config('app.spo_status') as $spo_statusField)
                                            <option value="{{ $spo_statusField }}"
                                                {{ (old('spo_status') ?? $soloParent->spo_status) == $spo_statusField ? 'selected' : '' }}>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div>
                                            <input id="solo_parent_id_card_number" type="text"
                                                ...
                                                value="{{ old('solo_parent_id_card_number') ?? $soloParent->solo_parent_id_card_number }}">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div>
                                            <input id="solo_parent_category" type="text"
                                                ...
                                                value="{{ old('solo_parent_category') ?? $soloParent->solo_parent_category }}">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div>
                                            <input id="date_issuance" type="date"
                                                ...
                                                name="date_issuance"
                                                value="{{ old('date_issuance') ?? $soloParent->date_issuance }}">
                                            @error('date_issuance')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div>
                                            <input id="beneficiary_code" type="text"
                                                ...
                                                value="{{ old('beneficiary_code') ?? $soloParent->beneficiary_code }}">
    ...
    <script>
        ...
        let householdCompositionIndex =
            {{ old('householdCompositions') ? count(old('householdCompositions')) : count($soloParent->householdCompositions ?? []) }};
