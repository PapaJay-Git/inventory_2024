            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <span class="mx-1 fw-bold">UPDATE KABATAAN RECORD</span>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('kabataans.update', $kabataan->id) }}" method="POST"
                                ...
                                @foreach (config('app.kabataan_names') as $kabataan_name)
                                    <div class="col-6 col-md-4 col-lg-3">
                                        ...
                                        <input id="{{ $kabataan_name }}" type="text"
                                            ...
                                            name="{{ $kabataan_name }}"
                                            value="{{ old($kabataan_name) ?? $kabataan[$kabataan_name] }}">
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    ...
                                    <div>
                                        <input id="date_of_birth" type="date"
                                            ...
                                            name="date_of_birth"
                                            value="{{ old('date_of_birth') ?? $kabataan->date_of_birth }}" required>
                                        @error('date_of_birth')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        ...
                                        <select id="gender" class="form-control @error('gender') is-invalid @enderror"
                                            ...
                                            @foreach (config('app.sex') as $genderField)
                                                <option value="{{ $genderField }}"
                                                    {{ (old('gender') ?? $kabataan->gender) == $genderField ? 'selected' : '' }}>
                                                    {{ $genderField }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    ...
                                    <div>
                                        <input id="age" type="number"
                                            ...
                                            value="{{ old('age') ?? $kabataan->age }}" required>
                                        @error('age')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    ...
                                    <div>
                                        <input id="religion" type="text"
                                            ...
                                            value="{{ old('religion') ?? $kabataan->religion }}" required>
                                        @error('religion')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    ...
                                    <div>
                                        <input id="position" type="text"
                                            ...
                                            value="{{ old('position') ?? $kabataan->position }}" required>
                                        @error('position')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    ...
                                    <div>
                                        <input id="mobile_phone" type="text"
                                            ...
                                            name="mobile_phone"
                                            value="{{ old('mobile_phone') ?? $kabataan->mobile_phone }}" required>
                                        @error('mobile_phone')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    ...
                                    <div>
                                        <input id="barangay" type="text"
                                            ...
                                            value="{{ old('barangay') ?? $kabataan->barangay }}" required>
                                        @error('barangay')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    ...
                                    <div>
                                        <input id="city_municipality" type="text"
                                            ...
                                            value="{{ old('city_municipality') ?? $kabataan->city_municipality }}"
                                            required>
                                ...
                                <div class="col-12">
                                    ...
                                    <div>
                                        <textarea name="home_address" id="home_address" class="form-control @error('home_address') is-invalid @enderror"
                                            required maxlength="255">{{ old('home_address') ?? $kabataan->home_address }}</textarea>
                                        @error('home_address')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                @foreach (config('app.kabataan_education_fields') as $kabataan_education_fields)
                                    <div class="col-sm-9 col-md-8 col-lg-4">
                                        ...
                                        <input id="{{ $kabataan_education_fields[0] }}" type="text"
                                            ...
                                            value="{{ old($kabataan_education_fields[0]) ?? $kabataan[$kabataan_education_fields[0]] }}"
                                    ...
                                    <div class="col-sm-3 col-md-4 col-lg-2">
                                        ...
                                        <input id="{{ $kabataan_education_fields[1] }}" type="number"
                                            ...
                                            value="{{ old($kabataan_education_fields[1]) ?? $kabataan[$kabataan_education_fields[1]] }}"
                                ...
                                @foreach (config('app.kabataan_in_case_of_emergency') as $kabataan_in_case_of_emergency)
                                    <div class="col-12 col-md-6 col-lg-3">
                                        ...
                                        <input id="{{ $kabataan_in_case_of_emergency }}" type="text"
                                            ...
                                            value="{{ old($kabataan_in_case_of_emergency) ?? $kabataan[$kabataan_in_case_of_emergency] }}"
