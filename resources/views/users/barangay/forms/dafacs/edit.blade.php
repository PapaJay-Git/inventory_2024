...
@section('content')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <span class="mx-1 fw-bold">UPDATE DAFAC RECORD</span>
                    ...
                    <div class="card-body">
                        ...
                        <form action="/dafacs/{{ $dafac->id }}" method="POST"
                            ...
                            <div class="row row-gap-3">
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    ...
                                    <input id="serial_no" type="text"
                                        ...
                                        value="{{ old('serial_no') ?? $dafac->serial_no }}" required
                                        ...
                                        @foreach (config('app.dafac_address') as $dafac_addressField)
                                            <div class="col-12 col-md-6 col-lg-3">
                                                <input id="{{ $dafac_addressField }}" type="text"
                                                    name="{{ $dafac_addressField }}"
                                                    value="{{ old($dafac_addressField) ?? $dafac[$dafac_addressField] }}"
                                        ...
                                        @foreach (config('app.head_of_the_family') as $head_of_the_familyField)
                                            <div class="col-12 col-md-6 col-lg-4">
                                                <input id="{{ $head_of_the_familyField }}" type="text"
                                                    ...
                                                    value="{{ old($head_of_the_familyField) ?? $dafac[$head_of_the_familyField] }}"
                                ...
                                <div class="col-12 col-md-6 col-lg-3">
                                    ...
                                    <select id="sex" class="form-control @error('sex') is-invalid @enderror"
                                        ...
                                        @foreach (config('app.sex') as $sex)
                                            <option value="{{ $sex }}"
                                                {{ (old('sex') ?? $dafac->sex) == $sex ? 'selected' : '' }}>
                                                {{ $sex }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-12 col-md-4 col-lg-3">
                                    ...
                                    <input id="age" type="number"
                                        ...
                                        value="{{ old('age') ?? $dafac->age }}" required>
                                    @error('age')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-12 col-md-4 col-lg-3">
                                    ...
                                    <input id="date_of_birth" type="date"
                                        ...
                                        name="date_of_birth" value="{{ old('date_of_birth') ?? $dafac->date_of_birth }}"
                                        required>
                                    @error('date_of_birth')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                    ...
                                    <select id="occupation" class="form-control @error('occupation') is-invalid @enderror"
                                        ...
                                        @foreach (config('app.occupation') as $occupationField)
                                            <option value="{{ $occupationField }}"
                                                {{ (old('occupation') ?? $dafac->occupation) == $occupationField ? 'selected' : '' }}>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div>
                                            <input id="monthly_net_income" type="number"
                                                ...
                                                value="{{ old('monthly_net_income') ?? $dafac->monthly_net_income }}"
                                                required>
                                ...
                                <div class="col-12 col-md-6 col-lg-3">
                                    ...
                                    <div>
                                        <input id="type_of_ethnicity" type="text"
                                            ...
                                            value="{{ old('type_of_ethnicity') ?? $dafac->type_of_ethnicity }}"
                                ...
                                <div class="col-12">
                                    <div id="family_members">
                                        ...
                                        @foreach (old('family_members') ?? ($dafac->familyMembers ?? []) as $index => $family_member)
                                            <div class="row mb-2 row-gap-2 pb-2"
                                                ...
                                                <div class="col-md-4 col-lg-4">
                                                    ...
                                                    <div>
                                                        <input id="family_member_name_{{ $index }}" type="text"
                                                            ...
                                                            value="{{ old('family_members.' . $index . '.family_member_name') ?? ($family_member->family_member_name ?? '') }}">
                                                ...
                                                <div class="col-md-4 col-lg-3">
                                                    ...
                                                    <div>
                                                        <input id="relationship_to_head_{{ $index }}"
                                                            ...
                                                            value="{{ old('family_members.' . $index . '.relationship_to_head') ?? ($family_member->relationship_to_head ?? '') }}">
                                                ...
                                                <div class="col-md-4 col-lg-3">
                                                    ...
                                                    <input id="age_{{ $index }}" type="number"
                                                        ...
                                                        value="{{ old('family_members.' . $index . '.age') ?? ($family_member->age ?? '') }}">
                                                ...
                                                <div class="col-md-4 col-lg-3">
                                                    ...
                                                    <select id="gender_{{ $index }}"
                                                        ...
                                                        <option value="Male"
                                                            {{ (old('family_members.' . $index . '.gender') ?? ($family_member->gender ?? '')) == 'Male' ? 'selected' : '' }}>
                                                            {{ 'Male' }}
                                                        </option>
                                                        <option value="Female"
                                                            {{ (old('family_members.' . $index . '.gender') ?? ($family_member->gender ?? '')) == 'Female' ? 'selected' : '' }}>
                                                            {{ 'Female' }}
                                                        </option>
                                                    </select>
                                                ...
                                                <div class="col-md-4 col-lg-3">
                                                    ...
                                                    <div>
                                                        <input id="education_{{ $index }}" type="text"
                                                            ...
                                                            value="{{ old('family_members.' . $index . '.education') ?? ($family_member->education ?? '') }}">
                                                ...
                                                <div class="col-md-4 col-lg-3">
                                                    ...
                                                    <div>
                                                        <input id="occupational_skills_{{ $index }}"
                                                            ...
                                                            value="{{ old('family_members.' . $index . '.occupational_skills') ?? ($family_member->occupational_skills ?? '') }}">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div>
                                                        <textarea name="family_members[{{ $index }}][remarks]" id="remarks_{{ $index }}"
                                                            class="form-control  @error('family_members.' . $index . '.remarks') is-invalid @enderror">{{ old('family_members.' . $index . '.remarks') ?? ($family_member->remarks ?? '') }}</textarea>
                                    ...
                                    <select id="housing_type"
                                        ...
                                        @foreach (config('app.housing_type') as $housing_type)
                                            <option value="{{ $housing_type }}"
                                                {{ (old('housing_type') ?? $dafac->housing_type) == $housing_type ? 'selected' : '' }}>
                                                {{ $housing_type }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-12 col-md-6 col-lg-3">
                                    ...
                                    <select id="code" class="form-control @error('code') is-invalid @enderror"
                                        ...
                                        @foreach (config('app.code') as $code)
                                            <option value="{{ $code }}"
                                                {{ (old('code') ?? $dafac->code) == $code ? 'selected' : '' }}>
                                                {{ $code }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-12 col-md-6 col-lg-3">
                                    ...
                                    <select id="housing_condition"
                                        ...
                                        @foreach (config('app.housing_condition') as $housing_condition)
                                            <option value="{{ $housing_condition ?? $dafac->housing_condition }}"
                                    ...
                                    <select id="health_condition"
                                        ...
                                        @foreach (config('app.health_condition') as $health_condition)
                                            <option value="{{ $health_condition }}"
                                                {{ (old('health_condition') ?? $dafac->health_condition) == $health_condition ? 'selected' : '' }}>
                                                {{ $health_condition }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    ...
                                    <input id="name_of_brg_captain" type="text"
                                        ...
                                        name="name_of_brg_captain"
                                        value="{{ old('name_of_brg_captain') ?? $dafac->name_of_brg_captain }}"
                                        placeholder="Serial Number">
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    ...
                                    <input id="date_registered" type="date"
                                        ...
                                        value="{{ old('date_registered') ?? $dafac->date_registered }}"
                                        placeholder="Serial Number">
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    ...
                                    <input id="name_of_lswdo" type="text"
                                        ...
                                        name="name_of_lswdo" value="{{ old('name_of_lswdo') ?? $dafac->name_of_lswdo }}"
                                        placeholder="Serial Number">
                                    @error('name_of_lswdo')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
    ...
    <script>
        ...
        let familyMemberIndex =
            {{ old('family_members') ? count(old('family_members')) : count($dafac->family_members ?? []) }};
