                                ...
                                <tbody>
                                    @foreach ($barangays as $barangay)
                                        <tr>
                                            ...
                                            <td class="text-start text-nowrap fw-bold text-uppercase">{{ $barangay->name }}
                                            </td>
                                            <td class="text-start text-nowrap text-uppercase">{{ $barangay->psgc_barangay }}
                                            </td>
                                            <td class="text-start text-nowrap text-uppercase">{{ $barangay->username }}</td>
                                            <td class="d-flex flex-row gap-1 align-items-center">
                                                <a href="{{ "/barangay-accounts/$barangay->id/edit" }}"
                                                    class="btn btn-sm fw-bold btn-primary m-1 text-nowrap">Edit</a>
                                                <form action="/barangay-accounts/{{ $barangay->id }}" method="POST"
                                                    ...
                                                    @method('delete')
                                                    <button type="submit"
                                                        class="btn btn-danger btn-sm fw-bold text-nowrap">Delete</button>
                                                </form>
                                            </td>
                                        </tr>
                                    @endforeach
