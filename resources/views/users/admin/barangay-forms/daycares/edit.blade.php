                ...
                <div class="card-body">
                    ...
                    <form action="/daycares/{{ $daycare->id }}" method="POST" onsubmit="return confirm('Are you sure you want to update this record?')">
                        ...
                        <div class="form-group row my-2">
                            ...
                            <div class="col-md-6">
                                <input id="facility_street_address" type="text" class="form-control @error('facility_street_address') is-invalid @enderror" name="facility_street_address" value="{{ old('facility_street_address') ?? $daycare->facility_street_address }}" placeholder="Street Address" required>
                                <input id="facility_barangay" type="text" class="form-control mt-1 @error('facility_barangay') is-invalid @enderror" name="facility_barangay" value="{{ old('facility_barangay') ?? $daycare->facility_barangay }}" placeholder="Barangay" required>
                                <input id="facility_city_municipality" type="text" class="form-control mt-1 @error('facility_city_municipality') is-invalid @enderror" name="facility_city_municipality" value="{{ old('facility_city_municipality') ?? $daycare->facility_city_municipality }}" placeholder="City/Municipality" required>
                                <input id="facility_province" type="text" class="form-control mt-1 @error('facility_province') is-invalid @enderror" name="facility_province" value="{{ old('facility_province') ?? $daycare->facility_province }}" placeholder="Province" required>
                                <input id="facility_region" type="text" class="form-control mt-1 @error('facility_region') is-invalid @enderror" name="facility_region" value="{{ old('facility_region') ?? $daycare->facility_region }}" placeholder="Region" required>
                        ...
                        <div class="form-group row my-2">
                            ...
                            <div class="col-md-6">
                                <input id="first_name" type="text" class="form-control @error('first_name') is-invalid @enderror" name="first_name" value="{{ old('first_name') ?? $daycare->first_name  }}" placeholder="First Name" required>
                                <input id="middle_name" type="text" class="form-control mt-1 @error('middle_name') is-invalid @enderror" name="middle_name" value="{{ old('middle_name') ?? $daycare->middle_name  }}" placeholder="Middle Name">
                                <input id="last_name" type="text" class="form-control mt-1 @error('last_name') is-invalid @enderror" name="last_name" value="{{ old('last_name') ?? $daycare->last_name }}" placeholder="Last Name" required>
                                <input id="ext" type="text" class="form-control mt-1 @error('ext') is-invalid @enderror" name="ext" value="{{ old('ext') ?? $daycare->ext  }}" placeholder="Extension (e.g., Jr., Sr.)" maxlength="10">
                                <input id="nickname" type="text" class="form-control mt-1 @error('nickname') is-invalid @enderror" name="nickname" value="{{ old('nickname') ?? $daycare->nickname }}" placeholder="Nickname">
                        ...
                        <div class="form-group row my-2">
                            ...
                            <div class="col-md-6">
                                <select id="sex" class="form-control @error('sex') is-invalid @enderror" name="sex" required>
                                    <option value="Male" {{ old('sex') ?? $daycare->sex == 'Male' ? 'selected' : '' }}>Male</option>
                                    <option value="Female" {{ old('sex') ?? $daycare->sex == 'Female' ? 'selected' : '' }}>Female</option>
                                </select>
                                @error('sex')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="form-group row my-2">
                            ...
                            <div class="col-md-6">
                                <input id="home_street_address" type="text" class="form-control @error('home_street_address') is-invalid @enderror" name="home_street_address" value="{{ old('home_street_address') ?? $daycare->home_street_address }}" placeholder="Street Address" required>
                                <input id="home_barangay" type="text" class="form-control mt-1 @error('home_barangay') is-invalid @enderror" name="home_barangay" value="{{ old('home_barangay') ?? $daycare->home_barangay }}" placeholder="Barangay" required>
                                <input id="home_city_municipality" type="text" class="form-control mt-1 @error('home_city_municipality') is-invalid @enderror" name="home_city_municipality" value="{{ old('home_city_municipality') ?? $daycare->home_city_municipality }}" placeholder="City/Municipality" required>
                                <input id="home_province" type="text" class="form-control mt-1 @error('home_province') is-invalid @enderror" name="home_province" value="{{ old('home_province') ?? $daycare->home_province  }}" placeholder="Province" required>
                                <input id="home_region" type="text" class="form-control mt-1 @error('home_region') is-invalid @enderror" name="home_region" value="{{ old('home_region') ?? $daycare->home_region   }}" placeholder="Region" required>
                                ...
                                <div class="mt-3">
                                    <div>
                                        ...
                                        <select id="kind_of_breastfeeding" class="form-control @error('kind_of_breastfeeding') is-invalid @enderror" name="kind_of_breastfeeding" required>
                                            <option value="Exclusive" {{ (old('kind_of_breastfeeding') ?? $daycare->kind_of_breastfeeding) == 'Exclusive' ? 'selected' : '' }}>Exclusive</option>
                                            <option value="Mixed" {{ (old('kind_of_breastfeeding') ?? $daycare->kind_of_breastfeeding) == 'Mixed' ? 'selected' : '' }}>Mixed</option>
                                        </select>
                                    </div>
                                ...
                                <div class="mt-3">
                                    <div>
                                        ...
                                        <select id="parents_counterpart" class="form-control @error('parents_counterpart') is-invalid @enderror" name="parents_counterpart" required>
                                            <option value="Cash" {{ (old('parents_counterpart') ?? $daycare->parents_counterpart) == 'Cash' ? 'selected' : '' }}>Cash</option>
                                            <option value="In Kind" {{ (old('parents_counterpart') ?? $daycare->parents_counterpart) == 'In Kind' ? 'selected' : '' }}>In Kind</option>
                                            <option value="None" {{ (old('parents_counterpart') ?? $daycare->parents_counterpart) == 'None' ? 'selected' : '' }}>None</option>
                                        </select>
                                    </div>
                        ...
                        <div class="form-group row my-2">
                            ...
                            <div class="col-md-6">
                                <select id="scheduled_session" class="form-control @error('scheduled_session') is-invalid @enderror" name="scheduled_session" required>
                                    <option value="Morning" {{ (old('scheduled_session') ?? $daycare->scheduled_session) == 'Morning' ? 'selected' : '' }}>Morning</option>
                                    <option value="Afternoon" {{ (old('scheduled_session') ?? $daycare->scheduled_session) == 'Afternoon' ? 'selected' : '' }}>Afternoon</option>
                                </select>
                        ...
                        <div class="form-group row my-2">
                            ...
                            <div class="col-md-6">
                                <select id="attendance_status" class="form-control @error('attendance_status') is-invalid @enderror" name="attendance_status" required>
                                    <option value="Continuing" {{ (old('attendance_status') ?? $daycare->attendance_status) == 'Continuing' ? 'selected' : '' }}>Continuing</option>
                                    <option value="Dropped Out" {{ (old('attendance_status') ?? $daycare->attendance_status) == 'Dropped Out' ? 'selected' : '' }}>Dropped Out</option>
                                    <option value="Graduated" {{ (old('attendance_status') ?? $daycare->attendance_status) == 'Graduated' ? 'selected' : '' }}>Graduated</option>
                                </select>
                                ...
                                <div class="mt-3">
                                    <div>
                                        ...
                                        <select id="dropout_reason" class="form-control @error('dropout_reason') is-invalid @enderror" name="dropout_reason" required>
                                            ...
                                            <option value="Illness" {{ (old('dropout_reason') ?? $daycare->dropout_reason) == 'Illness' ? 'selected' : '' }}>Illness</option>
                                            <option value="Transfer of Residence" {{ (old('dropout_reason') ?? $daycare->dropout_reason) == 'Transfer of Residence' ? 'selected' : '' }}>Transfer of Residence</option>
                                            <option value="Others" {{ (old('dropout_reason') ?? $daycare->dropout_reason) == 'Others' ? 'selected' : '' }}>Others</option>
                                        </select>
                                    </div>
