...
@section('title')
    Update Person with Disability (Pwd) Record
@endsection
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <span class="mx-1 fw-bold">UDPATE PWD RECORD</span>
                                    ...
                                    <div class="d-flex justify-content-start gap-2">
                                        <div class="card" style="width: 5rem; height: 5rem" id="photo-container">
                                            <img src="{{ config('app.pwd_images_path') . $pwd->pwd_photo }}"
                                                ...
                                                alt="PWD Photo Preview">
                                        </div>
                                        <div>
                                            <input type="file" name="pwd_photo" id="pwd_photo" accept="image/*"
                                                class="form-control  @error('pwd_photo') is-invalid @enderror">
                                            @error('pwd_photo')
                                ...
                                <div class="col-md-6 col-lg-3 my-2">
                                    ...
                                    <div>
                                        <input id="disability_number" type="text"
                                            ...
                                            value="{{ old('disability_number') ?? $pwd->disability_number }}" required>
                                ...
                                <div class="col-md-4 col-lg-2 my-2">
                                    ...
                                    <div>
                                        <input id="date_applied" type="date"
                                            ...
                                            name="date_applied" value="{{ old('date_applied') ?? $pwd->date_applied }}"
                                            required>
                                        @error('date_applied')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                        ...
                                        @foreach (config('app.personal_information') as $facilityField)
                                            <div>
                                                <input id="{{ $facilityField }}" type="text"
                                                    ...
                                                    name="{{ $facilityField }}"
                                                    value="{{ old($facilityField) ?? $pwd[$facilityField] }}"
                                ...
                                <div class="col-6 col-md-4 col-lg-2 my-2">
                                    ...
                                    <div>
                                        <input id="date_of_birth" type="date"
                                            ...
                                            name="date_of_birth" value="{{ old('date_of_birth') ?? $pwd->date_of_birth }}"
                                            required>
                                        @error('date_of_birth')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                    ...
                                    <div>
                                        <select id="type_of_disabilities"
                                            ...
                                            @foreach (config('app.type_of_disabilities') as $type_of_disabilityField)
                                                ...
                                                @else
                                                    <option value="{{ $type_of_disabilityField }}"
                                                        {{ in_array($type_of_disabilityField, json_decode($pwd->type_of_disabilities, true) ?? []) ? 'selected' : '' }}>
                                                        {{ $type_of_disabilityField }}
                                                    </option>
                                                @endif
                                            @endforeach
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                <input id="cause_of_disability_others" type="text"
                                                    ...
                                                    value="{{ old('cause_of_disability_others') ?? $pwd->cause_of_disability_others }}">
                                        ...
                                        @foreach (config('app.residence_address') as $residence_addressField)
                                            <div class="col-12 col-md-6 col-lg-4 gap-2">
                                                <input id="{{ $residence_addressField }}" type="text"
                                                    ...
                                                    value="{{ old($residence_addressField) ?? $pwd[$residence_addressField] }}"
                                        ...
                                        @foreach (config('app.contail_details') as $contail_detailsField)
                                            <div class="col-12 col-md-6 col-lg-4">
                                                <input id="{{ $contail_detailsField }}"
                                                    ...
                                                    value="{{ old($contail_detailsField) ?? $pwd[$contail_detailsField] }}"
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            <input id="occupation_others" type="text"
                                                ...
                                                value="{{ old('occupation_others') ?? $pwd->occupation_others }}">
                                        ...
                                        @foreach (config('app.organizational_information') as $organizational_informationField)
                                            <div class="col-12 col-md-6 col-lg-4">
                                                <input id="{{ $organizational_informationField }}" type="text"
                                                    ...
                                                    value="{{ old($organizational_informationField) ?? $pwd[$organizational_informationField] }}"
                                        ...
                                        @foreach (config('app.id_reference_no') as $id_reference_noField)
                                            <div class="col-12 col-md-6 col-lg-4">
                                                <input id="{{ $id_reference_noField }}" type="text"
                                                    ...
                                                    value="{{ old($id_reference_noField) ?? $pwd[$id_reference_noField] }}"
                                        ...
                                        @foreach (config('app.family_background') as $family_backgroundField)
                                            <div class="col-12 col-md-6 col-lg-4">
                                                <input id="{{ $family_backgroundField }}" type="text"
                                                    ...
                                                    value="{{ old($family_backgroundField) ?? $pwd[$family_backgroundField] }}"
                                        ...
                                        @foreach (config('app.accomplished_by_name') as $accomplished_by_nameField)
                                            <div class="col-12 col-md-6 col-4">
                                                <input id="{{ $accomplished_by_nameField }}" type="text"
                                                    ...
                                                    value="{{ old($accomplished_by_nameField) ?? $pwd[$accomplished_by_nameField] }}"
                                ...
                                <div class="col-md-4 col-lg-3 my-2">
                                    ...
                                    <div>
                                        <input id="name_of_certifying_physician" type="text"
                                            ...
                                            value="{{ old('name_of_certifying_physician') ?? $pwd->name_of_certifying_physician }}"
                                            required placeholder="Name of certifying physician">
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                <input id="license_no" type="text"
                                                    ...
                                                    name="license_no"
                                                    value="{{ old('license_no') ?? $pwd->license_no }}" required
                                ...
                                <div class="col-md-4 col-lg-3 my-2">
                                    ...
                                    <div>
                                        <input id="processing_officer" type="text"
                                            ...
                                            value="{{ old('processing_officer') ?? $pwd->processing_officer }}" required
                                ...
                                <div class="col-md-4 col-lg-3 my-2">
                                    ...
                                    <div>
                                        <input id="approving_officer" type="text"
                                            ...
                                            value="{{ old('approving_officer') ?? $pwd->approving_officer }}" required
                                ...
                                <div class="col-md-4 col-lg-3 my-2">
                                    ...
                                    <div>
                                        <input id="encoder" type="text"
                                            ...
                                            value="{{ old('encoder') ?? $pwd->encoder }}" required
                                            placeholder="Encoder">
                                        @error('encoder')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="col-md-4 col-lg-3 my-2">
                                    ...
                                    <div>
                                        <input id="name_of_reporting_unit_office_section" type="text"
                                            ...
                                            value="{{ old('name_of_reporting_unit_office_section') ?? $pwd->name_of_reporting_unit_office_section }}"
                                            required placeholder="Name of reporting unit (Office/Section)">
                                ...
                                <div class="col-md-4 col-lg-3 my-2">
                                    ...
                                    <div>
                                        <input id="control_no" type="text"
                                            ...
                                            name="control_no" value="{{ old('control_no') ?? $pwd->control_no }}"
                                            required placeholder="Control No.">
                                        @error('control_no')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
