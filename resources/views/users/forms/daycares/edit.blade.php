                            ...
                            <div class="row row-gap-3">
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    ...
                                    <input id="eccdfid" type="text"
                                        ...
                                        value="{{ old('eccdfid') ?? $daycare->eccdfid }}" required placeholder="ECCDF ID">
                                    @error('eccdfid')
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            <input id="facility_name" type="text"
                                                ...
                                                name="facility_name"
                                                value="{{ old('facility_name') ?? $daycare->facility_name }}" required>
                                            @error('facility_name')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            <input id="service_provider" type="text"
                                                ...
                                                value="{{ old('service_provider') ?? $daycare->service_provider }}"
                                                required>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6 col-lg-12">
                                            ...
                                            <select id="sex" class="form-control  @error('sex') is-invalid @enderror"
                                                ...
                                                @foreach (config('app.sex') as $sex)
                                                    <option value="{{ $sex }}"
                                                        {{ (old('sex') ?? $daycare->sex) == $sex ? 'selected' : '' }}>
                                                        {{ $sex }}</option>
                                                @endforeach
                                            </select>
                                            @error('sex')
                                        ...
                                        <div class="col-12 col-md-6 col-lg-12">
                                            ...
                                            <input id="birth_order" type="number"
                                                ...
                                                name="birth_order"
                                                value="{{ old('birth_order') ?? $daycare->birth_order }}" required>
                                            @error('birth_order')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                ...
                                <div class="col-12 col-md-4 col-lg-3">
                                    ...
                                    <div>
                                        <input id="no_of_siblings" type="number"
                                            ...
                                            name="no_of_siblings"
                                            value="{{ old('no_of_siblings') ?? $daycare->no_of_siblings }}" required>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            ...
                                            <input id="date_of_birth" type="date"
                                                ...
                                                name="date_of_birth"
                                                value="{{ old('date_of_birth') ?? $daycare->date_of_birth }}" required>
                                            @error('date_of_birth')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <input id="birth_registered" type="date"
                                                ...
                                                name="birth_registered"
                                                value="{{ old('birth_registered') ?? $daycare->birth_registered }}"
                                                required>
                                ...
                                <div class="col-12 col-md-4 col-lg-3">
                                    ...
                                    <div>
                                        <input id="birthplace" type="text"
                                            ...
                                            name="birthplace" value="{{ old('birthplace') ?? $daycare->birthplace }}"
                                            required>
                                        @error('birthplace')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div>
                                                <input id="religion" type="text"
                                                    ...
                                                    name="religion" value="{{ old('religion') ?? $daycare->religion }}">
                                                @error('religion')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div>
                                                <input id="ethnicity" type="text"
                                                    ...
                                                    name="ethnicity"
                                                    value="{{ old('ethnicity') ?? $daycare->ethnicity }}">
                                                @error('ethnicity')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="d-flex align-items-center gap-2">
                                                        <input type="checkbox" value="1" id="breastfeeding"
                                                            name="breastfeeding"
                                                            {{ old('breastfeeding') ?? $daycare->breastfeeding ? 'checked' : '' }}>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <input id="breastfed_for_months" type="number"
                                                        ...
                                                        value="{{ old('breastfed_for_months') ?? $daycare->breastfed_for_months }}">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4">
                                            <div>
                                                <div class="d-flex align-items-center gap-2">
                                                    <input type="checkbox" value="1" id="has_disability"
                                                        name="has_disability"
                                                        {{ old('has_disability') ?? $daycare->has_disability ? 'checked' : '' }}>
                                                    <label
                                            ...
                                            <div>
                                                ...
                                                <select id="referred_for_assistance"
                                                    ...
                                                    <option value="No"
                                                        {{ (old('referred_for_assistance') ?? $daycare->referred_for_assistance) == 'No' ? 'selected' : '' }}>
                                                        No</option>
                                                    <option value="Yes"
                                                        {{ (old('referred_for_assistance') ?? $daycare->referred_for_assistance) == 'Yes' ? 'selected' : '' }}>
                                                        Yes</option>
                                                </select>
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4">
                                            <div class="d-flex align-items-center gap-2">
                                                <input type="checkbox" value="1" id="listahanan_identified"
                                                    ...
                                                    {{ old('listahanan_identified') ?? $daycare->listahanan_identified ? 'checked' : '' }}>
                                                <label
                                            ...
                                            <div>
                                                <input type="checkbox" value="1" id="pantawid_beneficiary"
                                                    ...
                                                    {{ old('pantawid_beneficiary') ?? $daycare->pantawid_beneficiary ? 'checked' : '' }}>
                                            ...
                                            <div>
                                                ...
                                                <input id="household_id" type="number"
                                                    ...
                                                    name="household_id"
                                                    value="{{ old('household_id') ?? $daycare->household_id }}">
                                                @error('household_id')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div>
                                                ...
                                                <div>
                                                    <input id="supplementary_feeding_for_days" type="number"
                                                        ...
                                                        value="{{ old('supplementary_feeding_for_days') ?? $daycare->supplementary_feeding_for_days }}">
                                        ...
                                        <div>
                                            <div class="d-flex align-items-center gap-2">
                                                <input type="checkbox" value="1" id="participation_fee_paid"
                                                    ...
                                                    {{ old('participation_fee_paid') ?? $daycare->participation_fee_paid ? 'checked' : '' }}>
                                        ...
                                        <div>
                                            <div>
                                                ...
                                                <input id="participation_fee_amount" type="number"
                                                    ...
                                                    value="{{ old('participation_fee_amount') ?? $daycare->participation_fee_amount }}">
                                            </div>
                                ...
                                <div class="col-12 col-md-6 col-lg-4">
                                    <div>
                                        ...
                                        <input type="text" id="school_year" name="school_year"
                                            ...
                                            value="{{ old('school_year') ?? $daycare->school_year }}">
                                        @error('school_year')
                                            <span class="invalid-feedback d-block" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        ...
                                        <div class="mt-3">
                                            <div>
                                                ...
                                                <input id="dropout_reason_others" type="text"
                                                    ...
                                                    value="{{ old('dropout_reason_others') ?? $daycare->dropout_reason_others }}">
                                            </div>
                                    ...
                                    <div class="col-12 col-md-6 col-lg-3">
                                        ...
                                        <div>
                                            <input id="accomplished_by" type="text"
                                                ...
                                                value="{{ old('accomplished_by') ?? $daycare->accomplished_by }}">
                                    ...
                                    <div class="col-12 col-md-6 col-lg-3">
                                        ...
                                        <div>
                                            <input id="name_of_eccd_service_provider" type="text"
                                                ...
                                                value="{{ old('name_of_eccd_service_provider') ?? $daycare->name_of_eccd_service_provider }}">
                                    ...
                                    <div class="col-12 col-md-6 col-lg-3">
                                        ...
                                        <div>
                                            <input id="date_accomplished" type="date"
                                                ...
                                                value="{{ old('date_accomplished') ?? $daycare->date_accomplished }}">
                                    ...
                                    <div class="col-12 col-md-6 col-lg-3">
                                        ...
                                        <div>
                                            <input id="encoder_id" type="text"
                                                ...
                                                name="encoder_id"
                                                value="{{ old('encoder_id') ?? $daycare->encoder_id }}">
                                            @error('encoder_id')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
